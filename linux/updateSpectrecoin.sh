...
curl ${cacertParam} -L -s https://raw.githubusercontent.com/aliascash/installer/master/linux/updateSpectrecoin-${usedDistro}${releaseName}.sh | sudo bash -s "${versionToInstall}"
